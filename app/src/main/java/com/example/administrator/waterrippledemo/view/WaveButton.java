package com.example.administrator.waterrippledemo.view;
...
import com.example.administrator.waterrippledemo.R;
...
public class WaveButton extends RelativeLayout {
    ...
    public WaveButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mText1 = ta.getString(R.styleable.WaveButton_text1);
        mText2 = ta.getString(R.styleable.WaveButton_text2);
        if (mText == null) mText = "" ;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Rect rect1 = new Rect();//文字的区域
        mTextPaint.setColor(Color.WHITE);
        mTextPaint.getTextBounds(mText1,0,mText1.length(),rect1);
        mTextPaint.setColor(Color.WHITE);
        int height1 = rect1.height();
        int width1 = rect1.width();
        canvas.drawText(mText1,-width1/2,height1/2+height1+100,mTextPaint);

        Rect rect2 = new Rect();//文字的区域
        mTextPaint.setColor(Color.WHITE);
        mTextPaint.getTextBounds(mText2,0,mText2.length(),rect2);
        int height2 = rect2.height();
        int width2 = rect2.width();
        canvas.drawText(mText2,-width2/2,height2/2-height2-100,mTextPaint);
